...
class SSpApp(models.Model):
    _name = 'xero.s.sp.app'
    _description = 'xero_s_sp_app'
    _rec_name = 'web_user'

    shop_app_s_apps = fields.Many2one("xero.s.app", string='App')
    shop_app_s_shops = fields.Many2one("xero.s.shop", string='Shop')
    token_shop_app = fields.Char()
    web_user = fields.Char()
    shop_user_id = fields.Integer()

    # access_token = fields.Char()
    # refresh_tokenThe = fields.Char()
