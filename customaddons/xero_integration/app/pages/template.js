...
//       columns: [],
//       tableData: [],
//       // auth: 'Basic ' + new Buffer(props.user + ':' + props.pass),
//       auth: 'Basic ' + Buffer.from(props.user + ':' + props.pass, 'binary').toString('base64'),
//     };
...
//       rows.push(
//         <tr key={Buffer.from('row'+rows.length, 'binary').toString('base64')}>
...
//     return (
//           <div>
//             <h1 style={{fontSize: '1.2em', color: '#177CB8', marginBottom: '0'}}></h1>
//             <br/>
